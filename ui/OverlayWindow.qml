...
PanelWindow {
     ...
     * Uses simple string-based approach for improved security and maintainability.
     * 
     ...
     * - No regex patterns that could introduce complexity or vulnerabilities
     * - Simple string operations for predictable behavior
     */
